<?php
namespace libDb;
use libDb\Exception as libExpection; 
...
class Db
{
    ...
    public static function factory($adapter, array $config = array())
    {
        ...
        if (!is_array($config)) {
            ...
            throw new libExpection('Config parameters must be in an array ');
        }
        ...
        if (!is_string($adapter) || empty($adapter)) {
            throw new libExpection('Adapter name must be specified in a string');
        }

        /*
         * Form full adapter class name
         */
        $adapterNamespace = '\\libDb\Adapter';
        ...
        if (! $dbAdapter instanceof Adapter\AbstractAdapter) {
            throw new libExpection("Adapter class '$adapterName' does not extend AdapterAbstract");
        }
        return $dbAdapter;
