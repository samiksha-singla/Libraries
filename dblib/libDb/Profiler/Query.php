...
class Query
{
    ...
    /**
     * One of the \libDb\Profiler constants for query type, set by $queryType argument in constructor.
     *
     * @var integer
     */
     ...
     * type (one of the \libDb\Profiler::* constants).
     *
     * @param  string  $query
    ...
    /**
     * Get the type of this query (one of the \libDb\Profiler::* constants)
     *
     * @return integer
     */
