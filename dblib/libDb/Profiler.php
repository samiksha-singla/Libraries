...
class Profiler
{
    ...
    /**
     * Array of Profiler\Query objects.
     *
     * @var array
     */
     ...
     * the Profiler::* constants to only save profiles for that type of
     ...
     *
     * @param  Profiler\Query $query
     * @return integer or null
     */
    public function queryClone(Profiler\Query $query)
    {
    ...
    /**
     * Starts a query.  Creates a new query profile object (Profiler\Query)
     ...
     * @param  integer $queryType   OPTIONAL Type of query, one of the libDb\Profiler::* constants
     * @return integer|null
     */
    ...
    {
        // Don't do anything if the libDb\Profiler is not enabled.
        if (!$this->_enabled) {
            return self::IGNORED;
        }
     ...
     * by queryStart() and it will return a Profiler\Query object.
     *
     * @param  integer $queryId
     * @throws Profiler\Exception
     * @return Profiler\Query
     */
    ...
    /**
     * Get an array of query profiles (Profiler\Query objects).  If $queryType
     * is set to one of the Profiler::* constants then only queries of that
     ...
     * one or more of the Profiler::* constants, the elapsed time will be calculated
     ...
     * be counted.  If $queryType is set to one of the Profiler::* constants, only queries of
