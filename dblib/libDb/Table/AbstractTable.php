...
use libDb\Adapter\AbstractAdapter;
use libDb\Select;
use libDb\Db;
...
abstract class AbstractTable {
   ...
   /**
    * Default AbstractAdapter object.
    *
    * @var AbstractAdapter
    */
   ...
   /**
    * The table column names derived from AbstractAdapter::describeTable().
    *
    * @var array
    */
   protected $_cols;
    ...
    * @var string
    */
   protected $_rowClass = '\libDb\Table\Row';
    ...
    * @var string
    */
   protected $_rowsetClass = '\libDb\Table\Rowset';
    ...
    * extend \libDb\Table\AbstractTable.
    *
    * @var array
    */
    ...
    * @return \libDb\Table\AbstractTable Provides a fluent interface
    */
   ...
   /**
    * Sets the default AbstractAdapter for all \libDb\Table objects.
    *
   ...
   /**
    * Gets the default AbstractAdapter for all \libDb\Table objects.
    *
    * @return AbstractAdapter or null
    */
   ...
   /**
    * Gets the AbstractAdapter for this particular \libDb\Table object.
    *
   ...
   protected static function _setupAdapter($db) {
      ...
      if (is_string($db)) {
         $db = \libDb\Registry::get($db);
      }
      if (!$db instanceof AbstractAdapter) {
         throw new Exception('Argument must be of type AbstractAdapter, or a Registry key where a AbstractAdapter object is stored');
      }
      return $db;
   }

   /**
    * Sets the default metadata cache for information returned by AbstractAdapter::describeTable().
    *
   ...
   /**
    * Gets the default metadata cache for information returned by AbstractAdapter::describeTable().
    *
    * @return  \libDb\Registry or null
    */
   ...
   /**
    * Sets the metadata cache for information returned by AbstractAdapter::describeTable().
    *
   ...
   /**
    * Gets the metadata cache for information returned by AbstractAdapter::describeTable().
    *
    * @return  \libDb\Registry or null
    */
   ...
   protected function _setupDatabaseAdapter() {
      ...
      if (!$this->_db) {
         if ((null === $this->_db) && (null === ($adapter = $this->getAdapter()))) {
            $this->_db = \libDb\connect::connect();
   ...
   public function select($withFromPart = self::SELECT_WITHOUT_FROM_PART) {
      $select = new \libDb\Table\Select($this);
      if ($withFromPart == self::SELECT_WITH_FROM_PART) {
         $select->from($this->info(self::NAME), \libDb\Table\Select::SQL_WILDCARD, $this->info(self::SCHEMA));
      }
      return $select;
   }
   ...
   public function insert(array $data) {
      ...
      /**
       * \libDb\Table assumes that if you have a compound primary key
    ...
    * @return Rowset\RowsetAbstract Row(s) matching the criteria.
    * @throws Exception
    */
    ...
    * Fetches all rows.
    *
    * Honors the \libDb\Adapter fetch mode.
    *
    * @param string|array|Select $where  OPTIONAL An SQL WHERE clause or Select object.
    * @param string|array                      $order  OPTIONAL An SQL ORDER clause.
    * @param int                               $count  OPTIONAL An SQL LIMIT count.
    * @param int                               $offset OPTIONAL An SQL LIMIT offset.
    * @return Rowset\RowsetAbstract The row results per the \libDb\Adapter fetch mode.
    */
   ...
   /**
    * Fetches one row in an object of type Row\RowAbstract,
    * or returns null if no row matches the specified criteria.
    *
    * @param string|array|Select $where  OPTIONAL An SQL WHERE clause or Select object.
    * @param string|array                      $order  OPTIONAL An SQL ORDER clause.
    * @param int                               $offset OPTIONAL An SQL OFFSET value.
    * @return Row\RowAbstract|null The row results per the
    *     \libDb\Adapter fetch mode, or null if no row found.
    */
