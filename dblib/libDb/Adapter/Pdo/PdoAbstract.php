...
use libDb\Statement\Pdo;

abstract class PdoAbstract extends \libDb\Adapter\AbstractAdapter {
    ...
    * @var string
    */
   protected $_defaultStmtClass = '\\libDb\Statement\Pdo';
   ...
   public function prepare($sql) {
      ...
      if (!class_exists($stmtClass)) {
         throw new \libDb\Exception('Statement Class not found');
      }
   ...
   public function exec($sql) {
      if ($sql instanceof \libDb\Select) {
         $sql = $sql->assemble();
      }
      ...
      try {
         ...
         if ($affected === false) {
            ...
            throw new \libDb\Adapter\Exception($errorInfo[2]);
         }
   ...
   public function setFetchMode($mode) {
      ...
      switch ($mode) {
         ...
         case \PDO::FETCH_OBJ:
            ...
            break;
         default:
            throw new \libDb\Adapter\Exception("Invalid fetch mode '$mode' specified");
            break;
      }
   }
